...
public interface RequestContext {
    ...
    public static final Map<String, RequestResourceAccessStrategy> REQUEST_RESOUCE_ACCESS_STRATEGY = new HashMap<String, RequestResourceAccessStrategy>() {
    ...
    public static void registRequestResourceAccessStrategy(String key, RequestResourceAccessStrategy value) {
        REQUEST_RESOUCE_ACCESS_STRATEGY.put(key, value);
    }
    ...
    public default RequestResourceAccessStrategy getDefaultResourceAccessStrategy() {
        ...
        if (null != requestResource) {
            requestResourceAccessStrategy = REQUEST_RESOUCE_ACCESS_STRATEGY.get(requestResource.getAccessStrategy());
        }
    ...
    public default RequestResourceAccessStrategy getResourceAccessStrategyRequired() {
        RequestResource requestResource = getRequestResource();
        Validate.notNull(requestResource, "requestResource must not be null");
        RequestResourceAccessStrategy requestResourceAccessStrategy = REQUEST_RESOUCE_ACCESS_STRATEGY
                .get(requestResource.getAccessStrategy());
